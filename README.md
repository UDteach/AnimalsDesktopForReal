...
現在は最初の動作版です。チンチラ3毛色、ゴールデンハムスター2毛色、ジャンガリアンハムスターのノーマル1種類、マカロニマウスの自然色1種類、フクロモモンガ3毛色・模様の計10種類を収録しています。静止画像は実在する種と毛色の資料をもとに ImageGen で制作した透明素材です。動作は種ごとに全19パターン。各毛色・模様用に作った透過 WebM が合計37本あります。動画を再生できない環境では透明 PNG 演出に切り替わります。
