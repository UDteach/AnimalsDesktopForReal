...
現在は最初の動作版です。チンチラ3毛色、ゴールデンハムスター2毛色、ジャンガリアンハムスターのノーマル1種類、マカロニマウスの自然色1種類、フクロモモンガ3毛色・模様の計10種類を収録しています。静止画像は実在する種と毛色の資料をもとに ImageGen で制作した透明素材です。地上の4種には下から顔を出す動きを加え、全19パターン・37本の透過 WebM を再生します。動画を再生できない環境では透明 PNG 演出に切り替わります。
